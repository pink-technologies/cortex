 ...
 *
 * Owns the configured API base URL and shared {@link Session}. Resources such
 * as {@link CortexExecutionJobResource} and {@link CortexNodeResource} call
 * {@link request} with relative `/internal/...` paths, then
 * {@link CortexRequest.response} or {@link CortexRequest.responseJson}.
 */
@Injectable()
export class CortexClient {
   ...
   *
   * @param configuration - Host configuration providing the complete API base URL.
   */
  constructor(
