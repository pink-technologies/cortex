 ...
 * {@link Error.cause}.
 */
export class GitHubPullLookupError extends NodeApplicationError {
  // MARK: - Properties
 ...
 */
export class GitHubDraftPullCreationError extends NodeApplicationError {
  // MARK: - Properties
 ...
 * omits `html_url`.
 */
export class GitHubDraftPullMissingUrlError extends NodeApplicationError {
  // MARK: - Properties
