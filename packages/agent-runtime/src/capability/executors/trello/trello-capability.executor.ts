 ...
 */
export const TRELLO_CREDENTIALS_TOKEN: InjectionToken<TrelloCredentials> =
  Symbol('TRELLO_CREDENTIALS');
 ...
 */
@Injectable()
export class TrelloCapabilityExecutor implements CapabilityExecutor<
...
> {
  ...
  /**
   * Creates a new Trello capability executor.
   *
