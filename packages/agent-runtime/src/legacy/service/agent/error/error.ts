 ...
 */
export class AgentAlreadyRegisteredError extends AgentModuleError {
  // MARK: - Properties
 ...
 * loaded agent.
 */
export class AgentLoadError extends AgentModuleError {
  // MARK: - Properties
 ...
 */
export class AgentNotFoundError extends AgentModuleError {
  // MARK: - Properties
 ...
 * `Storage.read`.
 */
export class FailedToGetMainAgentError extends AgentModuleError {
  // MARK: - Properties
 ...
 */
export class DuplicateMainAgentError extends AgentModuleError {
  // MARK: - Properties
 ...
 */
export class MainAgentNotFoundError extends AgentModuleError {
  /**
   * Machine-readable code for invalid agent role errors.
   * A machine-readable error code identifying the type of
   * agent service error.
