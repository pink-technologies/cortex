...
/**
 * Combined storage interface for reading and writing.
 *
...
export interface ReadableStorage {
     ...
     * @returns The decoded value, or `null` if no value exists for the key.
     * @throws When the read operation fails.
     */
