...
import { IsDefined, IsNotEmpty, IsPhoneNumber, Matches } from 'class-validator'
...
export class UpdateUserParametersDto {
  ...
  @IsNotEmpty({
    message: i18nValidationMessage('user.first_name_cannot_be_empty'),
  })
  ...
  @IsNotEmpty({
    message: i18nValidationMessage('user.last_name_cannot_be_empty'),
  })
  @Matches(/^[A-Za-zÁÉÍÓÚÜÑáéíóúüñ]+$/, {
  ...
  @IsPhoneNumber(undefined, {
    message: i18nValidationMessage('user.phone_must_be_valid'),
  })
  phone: string
}
