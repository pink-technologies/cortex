 ...
 *
 * ## Responsibilities
 * - Encapsulates all database access patterns for Agent entities
 ...
 * - Method names clearly express intent (e.g., `isAgentRegistered` vs generic `find`)
 ...
 *   const exists = await this.agentsRepository.isAgentRegistered(name);
 *   if (exists) {
 *     throw new AgentNameAlreadyRegisteredError();
 *   }
 * }
 * ```
 */
...
export class AgentsRepository {
     ...
     *
     * @param database - The database client used to perform agent operations.
